"""Legal-MCP - A comprehensive legal research MCP server built with FastMCP and mcp-refcache, providing AI assistants with structured access to legal information across multiple jurisdictions."""

__author__ = "Lucas Hänke de Cansino"
__email__ = "lucas.cansino@mail.de"
__license__ = "MIT"
