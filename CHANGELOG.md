...
- **Zed settings**: Use `uvx legal-mcp stdio` (PyPI install)

## [0.0.1] - 2024-12-14

### Added

- Initial release of Legal-MCP
...
[Unreleased]: https://github.com/l4b4r4b4b4/legal-mcp/compare/v0.0.3...HEAD
[0.0.3]: https://github.com/l4b4r4b4b4/legal-mcp/releases/tag/v0.0.3
[0.0.2]: https://github.com/l4b4r4b4b4/legal-mcp/releases/tag/v0.0.2
[0.0.1]: https://github.com/l4b4r4b4b4/legal-mcp/releases/tag/v0.0.1
